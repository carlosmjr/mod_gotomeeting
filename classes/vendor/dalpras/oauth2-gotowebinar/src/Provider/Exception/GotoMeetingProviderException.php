...
namespace GoToMeeting\DalPraS\OAuth2\Client\Provider\Exception;

use Psr\Http\Message\ResponseInterface;
use League\OAuth2\Client\Provider\Exception\IdentityProviderException;

class GotoMeetingProviderException extends IdentityProviderException {
     ...
     *
     * @return GotoMeetingProviderException
     */
